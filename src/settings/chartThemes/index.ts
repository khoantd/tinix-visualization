...
// Danh sách màu chủ đề, Màu sắc tùy chỉnh được sử dụng UUID Là một mã định danh, vì hai cấu trúc dữ liệu không nhất quán
export type ChartColorsNameType = keyof typeof chartColors


// Danh sách màu chủ đề gradient (màu chính1, màu chủ đạo2, bóng, độ dốc1, độ dốc2）
